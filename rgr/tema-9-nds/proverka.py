...
check("U0 свёрткой, МДж/м³", u_conv, 0.12930, 5)
check("U0об = (1−2ν)/(6E)·I1н², МДж/м³",
      (1 - fnu * 2) / (6 * fE) * 6400, 0.00203, 5)
check("U0ф = U0 − U0об, МДж/м³", u_conv - (1 - 2 * fnu) / (6 * fE) * 6400,
      0.12727, 5)
...
check("U0ф = σэкв²/(6G), МДж/м³", s_ekv**2 / (6 * fGt), 0.12727, 5)
